const API_ERROR_MESSAGES: Record<string, string> = {
  ...
  'Category name already exists': '此分類名稱已存在',
  'Category is in use by restaurants': '仍有餐廳使用此分類，無法刪除',
  'No fields to update': '請至少填寫一個要更新的欄位',
  'categoryName is required': '請輸入分類名稱',
  'categoryName size is out of allowed range': '分類名稱不可超過 32 字',
