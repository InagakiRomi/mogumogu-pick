...
const orderBy = ref<OrderBy>('CREATED_AT')
...
<template>
  <main
    class="min-h-screen bg-[linear-gradient(rgba(255,255,255,0.24),rgba(255,255,255,0.24)),url('/images/homeBg.jpg')] bg-cover bg-center bg-no-repeat px-4 py-6 md:px-6"
  >
    <div
          ...
          <Table class="table-fixed">
            ...
            <TableBody>
              ...
              <TableRow v-for="restaurant in restaurants" :key="restaurant.restaurantId">
                ...
                <TableCell class="truncate font-medium" :title="restaurant.restaurantName ?? undefined">
                ...
                <TableCell class="truncate" :title="formatDate(restaurant.lastSelectedAt)">
