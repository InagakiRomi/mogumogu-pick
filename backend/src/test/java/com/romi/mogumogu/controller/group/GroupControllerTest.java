...
class GroupControllerTest {
        ...
        class GetMyGroupMembers {
                ...
                void serviceThrowsUnexpectedException_returns500() throws Exception {
                        ...
                        assertErrorResponse(mockMvc.perform(get(GROUPS_MY_MEMBERS_PATH)),
                                        HttpStatus.INTERNAL_SERVER_ERROR, GROUPS_MY_MEMBERS_PATH,
        ...
        class AddGroupMember {
                ...
                void notInGroup_returns400() throws Exception {
                        ...
                        assertErrorResponse(
                                        performPostMembers(AddGroupMemberDto.builder().email("new-user@example.com")
                                                        .build()),
                                        HttpStatus.BAD_REQUEST, GROUPS_MY_MEMBERS_PATH, "User is not in a group");
                ...
                void forbidden_returns403() throws Exception {
                        ...
                        assertErrorResponse(
                                        performPostMembers(AddGroupMemberDto.builder().email("new-user@example.com")
                                                        .build()),
                                        HttpStatus.FORBIDDEN, GROUPS_MY_MEMBERS_PATH,
                                        "Only group admin can perform this action");
                ...
                void targetNotFound_returns404() throws Exception {
                        ...
                        assertErrorResponse(
                                        performPostMembers(AddGroupMemberDto.builder().email("unknown@example.com")
                                                        .build()),
                ...
                void alreadyInGroup_returns400() throws Exception {
                        ...
                        assertErrorResponse(
                                        performPostMembers(
                                                        AddGroupMemberDto.builder().email("admin@example.com").build()),
                                        HttpStatus.BAD_REQUEST, GROUPS_MY_MEMBERS_PATH,
                                        "You are already in this group");
                ...
                void targetAlreadyInGroup_returns409() throws Exception {
                        when(groupService.addGroupMember(any(AddGroupMemberDto.class)))
                                        .thenThrow(new ResponseStatusException(HttpStatus.CONFLICT,
                                                        "Target user already belongs to a group"));

                        assertErrorResponse(
                                        performPostMembers(AddGroupMemberDto.builder().email("member@example.com")
                                                        .build()),
                                        HttpStatus.CONFLICT, GROUPS_MY_MEMBERS_PATH,
                                        "Target user already belongs to a group");
        ...
        class RemoveGroupMember {
                ...
                void notInGroup_returns400() throws Exception {
                        ...
                        assertErrorResponse(mockMvc.perform(delete(GROUPS_MY_MEMBERS_PATH + "/{userId}", 9)),
                                        HttpStatus.BAD_REQUEST, GROUPS_MY_MEMBERS_PATH + "/9",
                                        "User is not in a group");
                ...
                void forbidden_returns403() throws Exception {
                        ...
                        assertErrorResponse(mockMvc.perform(delete(GROUPS_MY_MEMBERS_PATH + "/{userId}", 9)),
                                        HttpStatus.FORBIDDEN, GROUPS_MY_MEMBERS_PATH + "/9",
                                        "Only group admin can perform this action");
                ...
                void cannotRemoveSelf_returns400() throws Exception {
                        ...
                        assertErrorResponse(mockMvc.perform(delete(GROUPS_MY_MEMBERS_PATH + "/{userId}", 1)),
                                        HttpStatus.BAD_REQUEST, GROUPS_MY_MEMBERS_PATH + "/1",
                                        "Cannot remove yourself via this endpoint");
                ...
                void invalidPathVariable_returns500AndSkipsServiceCall() throws Exception {
                        assertErrorResponseContains(
                                        mockMvc.perform(delete(GROUPS_MY_MEMBERS_PATH + "/{userId}", "bad-id")),
                                        HTTP_INTERNAL_SERVER_ERROR, CODE_INTERNAL_SERVER_ERROR,
                                        GROUPS_MY_MEMBERS_PATH + "/bad-id",
                ...
                void serviceThrowsUnexpectedException_returns500() throws Exception {
                        ...
                        assertErrorResponse(mockMvc.perform(delete(GROUPS_MY_MEMBERS_PATH + "/{userId}", 9)),
                                        HttpStatus.INTERNAL_SERVER_ERROR, GROUPS_MY_MEMBERS_PATH + "/9",
        ...
        class TransferGroupAdmin {
                ...
                void validationFailed_returns400AndSkipsService() throws Exception {
                        assertErrorResponseContains(
                                        ...
                                        400, CODE_BAD_REQUEST, GROUPS_MY_TRANSFER_ADMIN_PATH,
                                        "targetUserId must be greater than 0");
                        verifyNoInteractions(groupService);
                }
                ...
                void notInGroup_returns400() throws Exception {
                        ...
                        assertErrorResponse(
                                        performTransferAdmin(TransferGroupAdminDto.builder().targetUserId(20).build()),
                                        HttpStatus.BAD_REQUEST, GROUPS_MY_TRANSFER_ADMIN_PATH,
                                        "User is not in a group");
                ...
                void forbidden_returns403() throws Exception {
                        ...
                        assertErrorResponse(
                                        performTransferAdmin(TransferGroupAdminDto.builder().targetUserId(20).build()),
                                        HttpStatus.FORBIDDEN, GROUPS_MY_TRANSFER_ADMIN_PATH,
                                        "Only group admin can perform this action");
                ...
                void targetNotFound_returns404() throws Exception {
                        ...
                        assertErrorResponse(
                                        performTransferAdmin(TransferGroupAdminDto.builder().targetUserId(999).build()),
                ...
                void alreadyAdmin_returns400() throws Exception {
                        when(groupService.transferGroupAdmin(any(TransferGroupAdminDto.class)))
                                        .thenThrow(new ResponseStatusException(HttpStatus.BAD_REQUEST,
                                                        "Target user is already group admin"));
                ...
                void serviceThrowsUnexpectedException_returns500() throws Exception {
                        ...
                        assertErrorResponse(
                                        performTransferAdmin(TransferGroupAdminDto.builder().targetUserId(20).build()),
                                        HttpStatus.INTERNAL_SERVER_ERROR, GROUPS_MY_TRANSFER_ADMIN_PATH,
                                        "Transfer group admin failed");
        ...
        class GetGroupProfile {
                ...
                void success_returnsProfile() throws Exception {
                        when(groupService.getMyGroupProfile())
                                        .thenReturn(GroupProfileResponse.builder().groupId(1).groupName("午餐小隊")
                                                        .build());
        ...
        class UpdateGroupProfile {
                ...
                void success_returnsUpdatedProfile() throws Exception {
                        ...
                        when(groupService.updateMyGroupName(any(UpdateGroupNameDto.class)))
                                        .thenReturn(GroupProfileResponse.builder().groupId(1).groupName("新群組名")
                                                        .build());
                ...
                void emptyName_returns400AndSkipsService() throws Exception {
                        assertBadRequestValidation(
                                        performPatchProfile(UpdateGroupNameDto.builder().groupName("").build()),
                ...
                void missingBody_returns500AndSkipsService() throws Exception {
                        assertErrorResponseContains(
                                        mockMvc.perform(patch(GROUPS_MY_PATH).contentType(CONTENT_TYPE_JSON)),
                ...
                void forbidden_returns403() throws Exception {
                        ...
                        assertErrorResponse(performPatchProfile(UpdateGroupNameDto.builder().groupName("新名稱").build()),
                                        HttpStatus.FORBIDDEN, GROUPS_MY_PATH,
                                        "Only group admin can perform this action");
        ...
        class LeaveGroup {
                ...
                void adminNeedTransfer_returns400() throws Exception {
                        ...
                        assertErrorResponse(mockMvc.perform(post(GROUPS_MY_LEAVE_PATH)),
                                        HttpStatus.BAD_REQUEST, GROUPS_MY_LEAVE_PATH,
                                        "Please transfer group admin before leaving");
                        verify(groupService).leaveMyGroup();
                }
