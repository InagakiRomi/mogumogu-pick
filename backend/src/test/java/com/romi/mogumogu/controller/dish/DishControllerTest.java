...
class DishControllerTest {
        ...
        private static final String TRUNCATED_CREATE_DISH_JSON = "{\"restaurantId\":1,\"price\":130,\"dishName\":\"abc\"";
        ...
        class CreateDish {
                ...
                void serviceThrowsUnexpectedException_returns500() throws Exception {
                        ...
                        assertErrorResponse(performCreateDish(request),
                                        HttpStatus.INTERNAL_SERVER_ERROR, DISHES_PATH,
                                        "Create dish failed unexpectedly");
        ...
        class UpdateDish {
                ...
                void duplicateDisplayOrderId_returns400() throws Exception {
                        ...
                        assertErrorResponse(performUpdateDish(10, request),
                                        HttpStatus.BAD_REQUEST, "/dishes/10",
                                        "displayOrderId already exists in this restaurant");
